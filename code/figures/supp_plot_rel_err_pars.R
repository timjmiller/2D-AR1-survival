# Plot relative error in random effect parameters from simulation tests
...
plot_rel_err_pars <- function(stock.id="SNEMAYT", re="NAA", bc.type=2, sim.types=1:2, n.mods=4, n.sim=100, plot.eps=FALSE,
  ...
  #       facet_grid(rows=vars(om), cols=vars(par.lab.expr), scales='free', labeller = label_parsed) +
  #       theme_bw() +
