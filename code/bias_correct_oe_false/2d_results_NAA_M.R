...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/2d_results_NAA_M.R")
...
# load models
mod.list <- here("results","dat_2019","NAA_M",paste0(df.mods$Model,".rds"))
...
write.csv(df.mods, file=here("tables","dat_2019","NAA_M.csv"))
