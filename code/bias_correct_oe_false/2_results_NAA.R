...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/2_results_NAA.R")
...
# load models
mod.list <- here("results","dat_2019","NAA",paste0(df.mods$Model,".rds"))
...
write.csv(df.mods, file=here("tables","dat_2019","NAA.csv"))
