...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/1e_fit_models_NAA_M_iid.R")
...
for(m in 1:n.mods){
  ...
  saveRDS(mod, file=here("results","dat_2019","NAA_M_iid",paste0(df.mods$Model[m],".rds")))
}
