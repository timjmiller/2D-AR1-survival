...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/bias_correct_oe/1h_fit_models_NAA_CPI.R")
...
# input$map = input$map[!(names(input$map) %in% c("index_paa_pars", "catch_paa_pars"))]
  ...
  saveRDS(mod, file=here("results","dat_2019","bias_correct_oe","NAA_CPI",paste0(df.mods$Model[m],".rds")))
}
