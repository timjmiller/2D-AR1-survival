...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/bias_correct_oepe/2d_results_NAA_M.R")
...
write.csv(df.mods, file=here("tables","dat_2019","bias_correct_oepe_rev","NAA_M.csv"))
