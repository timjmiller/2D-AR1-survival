...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/bias_correct_oepe/1f_fit_models_NAA_CPI.R")
...
for(m in 1:n.mods){
  ...
  saveRDS(mod, file=here("results","dat_2019","bias_correct_oepe_rev","NAA_CPI",paste0(df.mods$Model[m],".rds")))
}
