...
for(m in 1:n.mods){
  ...
  # saveRDS(mod, file=here("results","dat_2019","bias_correct_oepe","NAA_M",paste0(df.mods$Model[m],".rds")))
  saveRDS(mod, file=here("results","dat_2019","bias_correct_oepe_rev","NAA_M",paste0(df.mods$Model[m],".rds")))
}

# collect fit models into a list
mod.list <- here("results","dat_2019","bias_correct_oepe_rev","NAA_M",paste0(df.mods$Model,".rds"))
