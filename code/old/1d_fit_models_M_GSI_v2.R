...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/1d_fit_models_M_GSI_v2.R")
...
# input$map = input$map[!(names(input$map) %in% c("index_paa_pars", "catch_paa_pars"))]
  ...
  saveRDS(mod, file=here("results","dat_2019","NAA_M_GSI_v2",paste0(df.mods$Model[m],".rds"))) 
}
