...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/1b_fit_models_estobserr.R")
...
# input$map = input$map[!(names(input$map) %in% c("index_paa_pars", "catch_paa_pars"))]
  ...
  saveRDS(mod, file=here("results","dat_2019","NAA_GSI_estobserr",paste0(df.mods$Model[m],".rds")))
}
