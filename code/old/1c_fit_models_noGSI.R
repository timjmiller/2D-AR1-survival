...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/1c_fit_models_noGSI.R")
...
# input$map = input$map[!(names(input$map) %in% c("index_paa_pars", "catch_paa_pars"))]
  ...
  saveRDS(mod, file=here("results","dat_2019","NAA_M_noGSI",paste0(df.mods$Model[m],".rds")))
}
