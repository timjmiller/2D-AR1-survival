...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/bias_correct_oe/2_results_NAA.R")
...
write.csv(df.mods, file=here("tables","dat_2019","bias_correct_oe","NAA.csv"))
