...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/bias_correct_oe/2e_results_NAA_M_iid.R")
...
# load models
mod.list <- here("results","dat_2019","NAA_M_iid",paste0(df.mods$Model,".rds"))
...
write.csv(df.mods, file=here("tables","dat_2019","bias_correct_oe","NAA_M_iid.csv"))
