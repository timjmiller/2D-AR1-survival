...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/2a_results_NAA_GSI.R")
...
# load models
mod.list <- here("results","dat_2019","NAA_GSI",paste0(df.mods$Model,".rds"))
...
write.csv(df.mods, file=here("tables","dat_2019","NAA_GSI.csv"))

# dAIC boxplot, group by GSI-Rec model
# point: 2D AR1 does best no matter how you model Recruitment/GSI
df <- read.csv(here("tables","dat_2019","NAA_GSI.csv"), stringsAsFactors=F)[,-1]
