...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/bias_correct_oe_v2/1b_fit_models_M.R")
...
for(m in 2:n.mods){ # Base.rds from NAA runs
  ...
  saveRDS(mod, file=here("results","dat_2019","bias_correct_oe_v2","M",paste0(df.mods$Model[m],".rds")))
}
