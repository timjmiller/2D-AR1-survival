...
# source("/home/bstock/Documents/ms/2D-AR1-survival/code/bias_correct_oe_v2/1d_fit_models_NAA_M_CPI.R")
...
for(m in 1:n.mods){
  ...
  saveRDS(mod, file=here("results","dat_2019","bias_correct_oe_v2","NAA_M_CPI",paste0(df.mods$Model[m],".rds")))
}
